...
# clf2 = DecisionTreeClassifier(criterion="entropy", max_depth=8, )  # 2 Accuracy: 0.8476127709431751
...
clf = DecisionTreeClassifier(criterion="entropy", max_depth=8, min_samples_leaf=55)  # 2 Accuracy: 0.8476127709431751
# clf = DecisionTreeClassifier()  # 2 Accuracy: 0.8476127709431751
clf = clf.fit(X_train, y_train)  # train the tree

# plot decision tree
# plt.figure(figsize=(14, 7))
# tree.plot_tree(decision_tree=clf, rounded=True, feature_names=feature_cols1,
#                fontsize=6, label="none", filled=True, impurity=False)
# plt.show()
